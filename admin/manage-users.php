                ...
                <tbody>
                    <?php while ($user = mysqli_fetch_assoc($users)) : ?>
                        <tr>
                            ...
                            <td><a href="<?= ROOT_URL ?>admin/delete-user.php?id=<?= $user['id'] ?>" class="btn sm danger">Deletar</a></td>
                            <td><?php if($user['is_admin'] == 1) {echo 'Administrador';} elseif($user['is_admin'] == 2){echo'Escritor';} else{echo 'Usuário';} ?></td>
                        </tr>
                    <?php endwhile ?>
                </tbody>
            </table>
            <?php else : ?>
                <div class="alert__message error"><?= "Usuário não encontrado" ?></div>
            <?php endif ?>
        </main>
    </div>
</section>
