                ...
                <tbody>
                    <?php while($category = mysqli_fetch_assoc($categories)) : ?>
                        <tr>
                            ...
                            <td><a href="<?= ROOT_URL ?>admin/delete-category.php?id=<?= $category['id'] ?>" class="btn sm danger">Deletar</a></td>
                        </tr>
                    <?php endwhile ?>
                </tbody>
            </table>
            <?php else : ?>
                <div class="alert__message error"><?= "Nenhuma categoria encontrada" ?></div>
            <?php endif ?>
        </main>
    </div>
</section>
