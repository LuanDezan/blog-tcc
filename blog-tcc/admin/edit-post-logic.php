...
if (isset($_POST['submit'])) {
    ...
    if(!$title) {
        $_SESSION['edit-post'] = "Não foi possível atualizar a postagem. Dados de formulário inválidos na página de edição da postagem.";
    } elseif (!$category_id) {
        $_SESSION['edit-post'] = "Não foi possível atualizar a postagem. Dados de formulário inválidos na página de edição da postagem.";
    } elseif (!$body) {
        $_SESSION['edit-post'] = "Não foi possível atualizar a postagem. Dados de formulário inválidos na página de edição da postagem.";
        ...
        if($thumbnail['name']) {
            ...
            if(in_array($extension, $allowed_files)) {
                ...
                if ($thumbnail['size'] < 2000000) {
                    ...
                    $_SESSION['edit-post'] = "Não foi possível atualizar a postagem. O tamanho da imagem deve ser inferior a 2 MB";
                }
            } else {
                $_SESSION['edit-post'] = "Não foi possível atualizar a postagem. A imagem deve ser png, jpg ou jpeg";
            }
        }
    }
